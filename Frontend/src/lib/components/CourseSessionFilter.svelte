    ...
    <div class="join join-vertical">
                ...
                {#each courseTypes as courseType}
                    <label class="form-control">
                        <label class="label cursor-pointer">
                            <input type="checkbox" bind:this={courseTypeCheckboxes[courseType.id]}
                                   bind:value={courseType.id} on:change={handleFilterChange} class="checkbox"/>
        ...
        <div class="collapse collapse-arrow bg-base-200">
            ...
            <div class="collapse-content">
                {#each courseOfferings as courseOffering}
                    <label class="form-control">
                        <label class="label cursor-pointer">
                            <input type="checkbox" bind:this={courseOfferingCheckboxes[courseOffering.id]}
                                   bind:value={courseOffering.id} on:change={handleFilterChange} class="checkbox"/>
            ...
            <div class="collapse-content">
                {#each daysOfWeek as day, index}
                    <div class="form-control">
                        <label class="label cursor-pointer">
                            <input type="checkbox" bind:this={daysCheckboxes[index]} bind:value={day}
                                   on:change={handleFilterChange} class="checkbox"/>
        ...
        <div class="collapse collapse-arrow bg-base-200">
            ...
            <div class="collapse-content">
                <form class="grid grid-flow-col auto-cols-max space-x-5 justify-center">
                    <div>
                        <input type="date" bind:value={startDate} on:change={handleFilterChange}
                               class="input input-bordered input-sm w-full max-w-xs"/>
                    </div>
                    <div>
                        <input type="date" bind:value={endTime} on:change={handleFilterChange}
                               class="input input-bordered input-sm w-full max-w-xs"/>
                    </div>
                </form>
            </div>
        ...
        <div class="collapse collapse-arrow bg-base-200">
            ...
            <div class="collapse-content">
                <form class="grid grid-flow-col auto-cols-max space-x-5 justify-center">
                    <div>
                        <input type="time" bind:value={startTime} on:change={handleFilterChange}
                               class="input input-bordered input-sm w-full max-w-xs"/>
                    </div>
                    <div>
                        <input type="time" bind:value={endTime} on:change={handleFilterChange}
                               class="input input-bordered input-sm w-full max-w-xs"/>
                    </div>
                </form>
            </div>
        ...
        <div class="collapse collapse-arrow bg-base-200">
            ...
            <div class="collapse-content">
                {#each instructors as instructor}
                    <div class="form-control">
                        <label class="label cursor-pointer">
                            <input type="checkbox" bind:this={instructorCheckboxes[instructor.id]}
                                   bind:value={instructor.id} on:change={handleFilterChange} class="checkbox"/>
        ...
        <div class="collapse collapse-arrow bg-base-200">
            ...
            <div class="collapse-content">
                {#each rooms as room}
                    <label class="form-control">
                        <label class="label cursor-pointer">
                            <input type="checkbox" bind:this={roomCheckboxes[room.id]} bind:value={room.id}
                                   on:change={handleFilterChange} class="checkbox"/>
