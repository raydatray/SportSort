...
public class SportCenter
{
  ...
  public void delete()
  {
    while (specificSessions.size() > 0)
    {
      SpecificSession aSpecificSession = specificSessions.get(specificSessions.size() - 1);
  ...
  public String toString()
  {
    return super.toString() + "["+
            ...
            "closingHour" + ":" + getClosingHour()+ "]" + System.getProperties().getProperty("line.separator") +
